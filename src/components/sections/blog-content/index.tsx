...
import { TArticle, TArticleContentBlock } from "../blog-catalog/types";
        ...
        {article.content && (
            <div className={styles.blog__content}>
                {article.content.map((block, idx) => (
                    <span>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quos hic quas cupiditate dolorem ad sequi. Error, ad. Aut cum distinctio hic recusandae doloribus? Sit repudiandae excepturi eaque deserunt in cumque.</span>
                ))}
