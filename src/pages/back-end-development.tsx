...
const PROPS_SECTIONS = {
  ...
  info: {
    ...
    texts: [
      `In an increasingly digital world, Crocode is your trusted partner in delivering top-notch back end development services. As a comprehensive software and backend development services company, we have a commendable track record of successfully completed projects that have unlocked significant value for our clientele. Our proficient back-end services team tailors robust and secure solutions, ensuring optimum performance to match the unique needs of every client. With us, you can catalyze your digital core transformation with dependable back-end code.`.toUpperCase(),
    ],
  },
  cardGrid: {
    title: 'Our process',
...
const BackEndDevelopmentPage = ({ allRedirects, seo }: TPageProps) => {
